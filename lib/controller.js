        ...
        switch (responseType) {
            ...
            case "Asking for email":
                ...
                if (messageResponse.context.get_idea) {
                      mailText = JSON.stringify(messageResponse.context.match[0].email) + ' is working on ' +
                                      JSON.stringify(messageResponse.context.match[0].idea);
                      }
                  else {
                      mailText = 'Thank you for networking with The Entrepreneur Alliance. Your idea and contact information will be kept on file for 48 hours'
                  }
                      ...
                      ///////////////////////////////////////////////////////////
                        ...
                        return getIdea(messageResponse)
                            ...
                            if (messageResponse.context.matchCounter > 0 && messageResponse.context.have_email) {
                                  var newMailText = JSON.stringify(messageResponse.context.match[0].email) + ' is working on ' +
                                                    JSON.stringify(messageResponse.context.match[0].idea);
